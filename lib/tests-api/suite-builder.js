...
module.exports = function(suite) {
    ...
    this.skip = (browser, comment) => {
        ...
        return this.skip.in(browser, comment);
    };

    this.skip.in = (browsers, comment) => processSkip(browsers, comment);

    this.skip.notIn = (browser, comment) => processSkip(browser, comment, {negate: true});
...
function mkBrowsersMatcher(browsers, {negate} = {negate: false}) {
